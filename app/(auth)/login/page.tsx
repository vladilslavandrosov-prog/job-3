      ...
      <div className="w-full max-w-md">
        ...
        <div className="rounded-xl border border-[var(--border)] bg-[var(--bg-card)] p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Link href="/reset-password" className="text-xs text-[var(--primary)] hover:underline">Забыли пароль?</Link>
              </div>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs text-[var(--text-muted)] bg-[var(--bg-card)] px-2">или</div>
          </div>
